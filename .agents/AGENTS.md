# Agent Guidelines: Aegis Hub (Project Phoenix)
...
## Agent Cluster Roles
1. **The Architect (Lead/Planner)**: Responsible for Next.js App Router layout, page routing, global state, ad space preservation, and glassmorphic design consistency.
